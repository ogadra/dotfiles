...
見出しを読めば分かることを本文に置く形。言い換えだけでなく、見出しの語から読み手が当然そうなると分かることも入る。コミットメッセージの件名と本文がこの形になりやすい。
...
2. 見出しごとに、書き手が直下の本文でその見出しの語に答えているか確かめる
    - 優先して見る見出し
        ...
        - `概要`
3. 見出しと直下の本文を対にする
    - 本文の文ごとに、見出しだけ渡された読み手が言い当てられるか確かめる
    - 見出しが動詞で始まる場合、その動作に伴う結果を本文が説明していないか確かめる
4. しないことの記述を集める
    - 探す見出し
        - `対象外`
        - `スコープ外`
