...
箇条書きの階層と粒度を見る。Markdownの組み立て方に出るクセ。
...
箇条書きの1項目に、読点やカンマで複数の語を並べる形。読み手はどれが並列でどれが補足なのか区別できず、1つだけ引用したいときに切り出せない。
...
各手順の説明とコマンドを1段下げ、環境変数を1つずつ項目にした。
...
2. 第1階層の項目に次の記号や語が入っている行を集める
    ...
    - `および`
    - 並列を1行に詰めていないか確かめる
3. 第1階層の項目に句点がある行を集める
    - 句点で文を切るほどの長さは第1階層に置かない
4. 次の語を含む箇条書きの項目を集める
    - `なら`
    - `場合は`
    - `if`
